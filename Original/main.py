...
COMFY_API_URL = "http://localhost:3000"  # 🔥 Update with your ComfyUI server URL
...
while True:
    ...
    try:
        ...
        # -----------------------------------
        base64_matt_image = get_base64_from_s3(STATIC_BUCKET, STATIC_KEY)
