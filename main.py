...
def build_prompt(base64_queue_image, base64_matt_image):
  ...
  "435": {
    "inputs": {
      "value": "Transform this simple portrait into a professional AWS-themed conference photo booth image featuring two professionals. Capture a natural business handshake moment, then finalize the pose with both standing beside each other, slightly angled 20 to 30 degrees toward the camera in a confident, composed stance. Posture should be upright and relaxed, executive and event-ready, not stiff. Arms should rest naturally by their sides or near a badge, blazer cuff, or smartwatch. Maintain calm, confident, approachable expressions and keep facial features unchanged.\n\nPlace them in front of a modern tech event backdrop with AWS-inspired orange and dark blue tones, abstract cloud icons, subtle server and network graphics, glowing data streams, and LED panels. Include a clean, accurate \"AWS\" logo that is perfectly rendered, correctly spelled, proportionally aligned, not distorted, not warped, not cropped, and not altered in any way. Keep the environment realistic and corporate without adding extra people.\n\nUse soft professional event lighting, natural skin tones, cinematic depth of field, slight background blur, subtle rim lighting, realistic shadows, sharp focus, ultra-detailed high resolution, and premium tech expo photography style."
    },
